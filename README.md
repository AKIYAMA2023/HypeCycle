...
Figure 2: Opinion Group Explain.py

Figure 3: Reproducing Hype Cycle organized.py

Figure 4: Combined awaness opinion tradeoff.py

Figure 5: Cluster Organized.py

Figure 6: Different d and mu organized 2.py

Figure 7: ShaleLOESSplot.rmd

Figure 8: Fracking Breakeven point.py

Figure 9: Stabilizer.py
...
Figure S7: Distribution skewed mean zero.py

Figure S8 and S9: Simulation Network.py Simulation Network Visualization.py

Figure S10 Adoption Expectation Coevolution.py

Figure S11 Media_Patterns_Comparison.py

Figure S12 Actor influence.py

Figure S13 Decreasing learning rate.py

## Note
As for survey data, we rely on the DESNZ public attitude tracker (https://www.gov.uk/government/collections/public-attitudes-tracking-survey) .
